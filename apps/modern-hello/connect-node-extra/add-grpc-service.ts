...
import { createGrpcServiceDefinition } from "./create-grpc-definition";
...
export type GrpcServiceImplementation<T extends ServiceType> = {
  [P in keyof T["methods"]]: T["methods"][P] extends
    MethodInfoUnary<infer I, infer O>
    ? grpc.handleUnaryCall<I, PartialMessage<O>>
    : T["methods"][P] extends MethodInfoServerStreaming<infer I, infer O>
      ? grpc.handleServerStreamingCall<I, PartialMessage<O>>
    : T["methods"][P] extends MethodInfoClientStreaming<infer I, infer O>
      ? grpc.handleClientStreamingCall<I, PartialMessage<O>>
    : T["methods"][P] extends MethodInfoBiDiStreaming<infer I, infer O>
      ? grpc.handleBidiStreamingCall<I, PartialMessage<O>>
    : never;
};
