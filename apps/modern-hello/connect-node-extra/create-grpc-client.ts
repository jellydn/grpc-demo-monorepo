...
export type GrpcClient<T extends ServiceType> = {
  [P in keyof T["methods"]]: T["methods"][P] extends
    MethodInfoUnary<infer I, infer O> ? C<I, O>["unary"]
...
interface C<I extends Message<I>, O extends Message<O>> extends grpc.Client {
  unary(
    argument: PartialMessage<I>,
    callback: grpc.requestCallback<O>,
